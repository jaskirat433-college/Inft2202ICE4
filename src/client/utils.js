 ...
 */
export function AddContact(router, fullName, contactNumber, emailAddress) {
 ...
 */
export function handleEditClick(event, router) {
 ...
 * @param router - The Router instance used to navigate.
 */
export function handleCancelClick(event, router) {
    event.preventDefault();
